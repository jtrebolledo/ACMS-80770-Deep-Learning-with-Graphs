...
class MyModel(nn.Module):
    def __init__(self, dim_inputlayer, dim_output):
        ...
        self.conv_mu         = nn.Linear(dim_output,2)
        self.conv_log_sigma  = nn.Linear(dim_output,2)
#         self.lin2 = nn.Linear(3,3)
    ...
    def forward(self, A, h0):
        ...
        latent_variables = x_mu  + torch.randn(self.dim_output,2) * x_log_sigma.exp()
        ...
        return A_hat_reconstructed, x_mu, x_log_sigma, latent_variables
